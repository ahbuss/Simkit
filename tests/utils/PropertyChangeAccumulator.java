...
import java.util.*;
/**
* Given a List of expected property changes, will fail an assertion if 
* they don't occur in the correct order.
**/
public class PropertyChangeAccumulator extends Assert implements PropertyChangeListener {

    protected List<PropertyChangeEvent> expected = new ArrayList<PropertyChangeEvent>();
    protected int count = 0;
    protected String propertyName = null;

/**
* Returns the length of the expected List.
**/
