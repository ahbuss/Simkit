...
//      protected float  label_value[]      = null;
      protected double  label_value[]      = null;    // ab 12-05-97
  /**
  ...
  /**
    * To tame the labels...  ab - 12-05-97
  **/
   ...
   */
      public void drawAxis(Graphics g) {
          ...
          if( minimum == maximum ) {
                 ...
                 if( minimum == maximum ) {
                    System.out.println(
                      "Axis: Reseting Range failed!  Axis not drawn! (min=" +
		         minimum + " max =" + maximum + ")");
                    return;
		  }
	  }
...
//          System.out.println("Drawing Vertical Axis!");
   ...
   */
      protected void calculateGridLabels() {
        ...
        label_value  = new double[label_count];  // ab 12-05-97
...
//            label_string[i] =  String.valueOf(val); // ab - 12-05-97
            label_string[i] =  df.format(val);
            label_value[i] = val;                   // ab - 12-05-97
