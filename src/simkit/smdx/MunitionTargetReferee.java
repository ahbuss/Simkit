...
*
    ...
    /**
     * Notifies this referee that the given Munition has impacted. This referee
     * checks each registered Target to see if it is located inside the impact
     * Shape of the Munition. If it is, then it gets an Adjudicator that
     ...
     *
     * @param target Given Target to add
     */
     ...
     *
     * @param target Given Target to remove
     */
    ...
    /**
     * 
     * @return a shallow copy of the list of registered Targets
     */
    ...
    /**
     * 
     * @param clear true if registered Targets will be cleared if this referee is reset.
     */
