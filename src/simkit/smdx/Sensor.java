 ...
 * {@link SensorTargetMediator} is responsible for determining if and when a
...
public interface Sensor extends Moveable, SimEntity, PropertyChangeListener {
     ...
     * minimize calls to {@code getFootprint}.
     * <p>
     * This method may be called frequently.
     * <p>
     * Treat as simulation state. Note: treating maxRange as simulation state
     * instead of as a simulation parameter is new after 2008-06-06. The
     * conceptual change comes from a need for sensor performance to be
     * (potentially) sensitive to conditions in the simulation. Also, the
     ...
     * <p>
     * Treat as simulation state, since the returned value may change based on
     * the movement of the Mover upon which the sensor is installed.
     *
     * @return Two-dimensional area within which detections are possible for
     * this Sensor
     */
     ...
     * start)
     *
     * @return The Mover on which this Sensor resides.
     */
     ...
     * start)
     *
     * @param mover The Mover on which this Sensor resides.
     */
    public void setMover(Mover mover);

    /**
     * Sensor Mediators schedule this event with the sensor as the scheduling
     * entity. (by calling {@code someSensor.waitDelay("Detection"...})
     * <p>
    ...
    /**
     * Sensor Mediators schedule this event with the sensor as the scheduling
     * entity. (by calling {@code someSensor.waitDelay("Undetection"...})
     * <p>
     ...
     * associated Mover.
     * <p>
     * Note. Some previous implementations used this event to re-schedule the
    ...
    /**
     * An event that indicates this Sensor has stopped moving. Fired by the
     * associated Mover.
     * <p>
     * Note. Some historical implementations used this event to re-schedule the
     * same event with no delay, but this behavior is not part of the contract,
     * and should not be relied upon.
     *
     */
