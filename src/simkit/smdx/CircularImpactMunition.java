...
/**
* Cancels all pending events and returns the Munition to its original location
* in an un-expended state.
**/
    public void reset() {
        super.reset();
        expended = false;
...
/**
* Stops this Munition at the aimpoint and schedules the Impact event
* for now.
**/
...
/**
* Returns a Shape that is a circle with radius equal to the impactRange centered on the
* aimpoint. This is the area that this Munition effects.
**/
...
* velocity, and whether or not expended of this Munition.
**/
...
/**
* It is up to a MunitionTargetReferee to determine the effect of 
* the Impact event. Simply fires a property change for the impact area.
**/
