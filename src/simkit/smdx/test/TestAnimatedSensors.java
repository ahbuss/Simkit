...
public class TestAnimatedSensors {
    ...
    public static void main(String[] args) {
        ...
        RandomVariate[] rv = new RandomVariate[] {
            RandomVariateFactory.getInstance("Uniform", new Object[] { new Double(-150.0), new Double(150.0) } ),
            RandomVariateFactory.getInstance("Uniform", new Object[] { new Double(-150.0), new Double(200.0) } )
        };
