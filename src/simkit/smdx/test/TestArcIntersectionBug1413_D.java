 ...
 * @version $Id$
 */
public class TestArcIntersectionBug1413_D extends JPanel {
    ...
    public TestArcIntersectionBug1413_D() {
        setOpaque(true);
        setBackground(Color.white);
        arc = new Shape[]{
            new Arc2D.Double(50.0, -50.0, 300.0, 300.0, 190.0, 170.0, Arc2D.PIE),
            new Arc2D.Double(50.0, 150.0, 300.0, 300.0, 190.0, 160.0, Arc2D.PIE)
        };
    ...
    public static void main(String args[]) {
        ...
        TestArcIntersectionBug1413_D taa = new TestArcIntersectionBug1413_D();
