...
public class MunitionTargetAdjudicatorFactory {
     ...
     *
     * @param munition Given Munition instance
     * @param target Given Target instance
     ...
     * @return Adjudicator for given Munition class and Target class
     */
     ...
     *
     * @param adjudicator Given Adjudicator
     */
