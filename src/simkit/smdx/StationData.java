...
* Implementations should give the point relative to the current guide position
* and leave it up to the FormationMoverManager to deal with the fact that the guide
* is moving.
