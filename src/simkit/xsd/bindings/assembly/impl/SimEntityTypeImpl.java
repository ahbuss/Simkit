...
public class SimEntityTypeImpl implements simkit.xsd.bindings.assembly.SimEntityType, com.sun.xml.bind.JAXBObject, simkit.xsd.bindings.assembly.impl.runtime.UnmarshallableObject, simkit.xsd.bindings.assembly.impl.runtime.XMLSerializable, com.sun.xml.bind.marshaller.IdentifiableObject, simkit.xsd.bindings.assembly.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (simkit.xsd.bindings.assembly.SimEntityType.class);
    }
    ...
    public simkit.xsd.bindings.assembly.impl.runtime.UnmarshallingEventHandler createUnmarshaller(simkit.xsd.bindings.assembly.impl.runtime.UnmarshallingContext context) {
        return new simkit.xsd.bindings.assembly.impl.SimEntityTypeImpl.Unmarshaller(context);
    }
...
+"/lang/Boolean;L\u0000\u000bexpandedExpq\u0000~\u0000\u0002xp\u0004\u00e65\u009fppsq\u0000~\u0000\u0000\u0003\u001b\u0014\u00d4ppsr\u0000\u001dcom"
...
+"s.assembly.TerminalParameterq\u0000~\u0000$q\u0000~\u0000\u001fsq\u0000~\u0000\u0016\u0002j\u00b8\u009dppsr\u0000\u001bcom.su"
...
+"eURIq\u0000~\u0000!xpq\u0000~\u0000=q\u0000~\u0000<sq\u0000~\u0000 t\u0000\u0004typet\u0000\u0000sq\u0000~\u0000\u0016\u0001\u00cb \u00c6ppsq\u0000~\u00002\u0000m\u0000Pp"
...
+"gType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001Z\u0000\risAlwaysValidxq\u0000~\u00007q\u0000~\u0000<t\u0000\u0002IDsr\u00005com.sun."
+"msv.datatype.xsd.WhiteSpaceProcessor$Collapse\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~"
+"\u0000?\u0000q\u0000~\u0000Bsq\u0000~\u0000Cq\u0000~\u0000Oq\u0000~\u0000<sq\u0000~\u0000 t\u0000\u0004nameq\u0000~\u0000Gsr\u0000\"com.sun.msv.gr"
...
+"entq\u0000~\u0000V[\u0000\u0005tablet\u0000![Lcom/sun/msv/grammar/Expression;xp\u0000\u0000\u0000\f\u0000\u0000"
+"\u00009pur\u0000![Lcom.sun.msv.grammar.Expression;\u00d68D\u00c3]\u00ad\u00a7\n\u0002\u0000\u0000xp\u0000\u0000\u0000\u00bfppp"
+"pppppppppppppppppppppppppppppppppppppppppppppppppppppppppppp"
+"pppppppppppppppppppppppppppppppppppppppppppppppppppppppppppp"
+"pq\u0000~\u0000\u0006pppppppq\u0000~\u0000\u000eppq\u0000~\u0000\u000bppppppppppq\u0000~\u0000\bpq\u0000~\u0000\u0015q\u0000~\u0000\'q\u0000~\u0000-q\u0000~\u0000"
+"\u000fpppppppq\u0000~\u0000\u0014q\u0000~\u0000&q\u0000~\u0000,pppppq\u0000~\u0000\u0005ppppppppppppppppppppppp"));
        }
        ...
        extends simkit.xsd.bindings.assembly.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return simkit.xsd.bindings.assembly.impl.SimEntityTypeImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  8 :
                        if (true) {
                            _Parameters.add(((simkit.xsd.bindings.assembly.impl.AnyTypeImpl) spawnChildFromEnterElement((simkit.xsd.bindings.assembly.impl.AnyTypeImpl.class), 9, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        _Parameters.add(((simkit.xsd.bindings.assembly.impl.AnyTypeImpl) spawnChildFromEnterElement((simkit.xsd.bindings.assembly.impl.AnyTypeImpl.class), 9, ___uri, ___local, ___qname, __atts)));
                        return ;
                    ...
                    case  7 :
                        if (("FactoryParameter" == ___local)&&("" == ___uri)) {
                            _Parameters.add(((simkit.xsd.bindings.assembly.impl.FactoryParameterImpl) spawnChildFromEnterElement((simkit.xsd.bindings.assembly.impl.FactoryParameterImpl.class), 7, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("MultiParameter" == ___local)&&("" == ___uri)) {
                            _Parameters.add(((simkit.xsd.bindings.assembly.impl.MultiParameterImpl) spawnChildFromEnterElement((simkit.xsd.bindings.assembly.impl.MultiParameterImpl.class), 7, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("TerminalParameter" == ___local)&&("" == ___uri)) {
                            _Parameters.add(((simkit.xsd.bindings.assembly.impl.TerminalParameterImpl) spawnChildFromEnterElement((simkit.xsd.bindings.assembly.impl.TerminalParameterImpl.class), 7, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Parameters" == ___local)&&("" == ___uri)) {
                            _Parameters.add(((simkit.xsd.bindings.assembly.impl.ParametersImpl) spawnChildFromEnterElement((simkit.xsd.bindings.assembly.impl.ParametersImpl.class), 7, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Parameters" == ___local)&&("" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  8 :
                        _Parameters.add(((simkit.xsd.bindings.assembly.impl.AnyTypeImpl) spawnChildFromLeaveElement((simkit.xsd.bindings.assembly.impl.AnyTypeImpl.class), 9, ___uri, ___local, ___qname)));
                        return ;
                    case  0 :
                        attIdx = context.getAttribute("", "type");
                        if (attIdx >= 0) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  8 :
                        _Parameters.add(((simkit.xsd.bindings.assembly.impl.AnyTypeImpl) spawnChildFromEnterAttribute((simkit.xsd.bindings.assembly.impl.AnyTypeImpl.class), 9, ___uri, ___local, ___qname)));
                        return ;
                    case  0 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  8 :
                        _Parameters.add(((simkit.xsd.bindings.assembly.impl.AnyTypeImpl) spawnChildFromLeaveAttribute((simkit.xsd.bindings.assembly.impl.AnyTypeImpl.class), 9, ___uri, ___local, ___qname)));
                        return ;
                    case  0 :
                        attIdx = context.getAttribute("", "type");
                        if (attIdx >= 0) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  8 :
                            _Parameters.add(((simkit.xsd.bindings.assembly.impl.AnyTypeImpl) spawnChildFromText((simkit.xsd.bindings.assembly.impl.AnyTypeImpl.class), 9, value)));
                            return ;
                        case  0 :
                            attIdx = context.getAttribute("", "type");
                            if (attIdx >= 0) {
