...
/**
 * <P>
 * This class filters events by name. A list of the names of filtered events is
 * kept, and selected events dispatched directly to listeners to an instance of
 * this class.
 * <P>
 * If <CODE>allButThese</CODE> is false (default), then any event whose name is
...
public class SimEventFilter extends simkit.BasicSimEntity {
     ...
     * events except for one. Do this by invoking the constructor with
    ...
    /**
     * @param b whether the events will be passed or all but the events will be
     * passed
     */
    public void setAllButTheseEvents(boolean b) {
        allButTheseEvents = b;
    }
     ...
     */
    public boolean isAllButTheseEvents() {
        return allButTheseEvents;
    }
