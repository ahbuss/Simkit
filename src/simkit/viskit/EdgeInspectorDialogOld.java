...
public class EdgeInspectorDialogOld extends JDialog
{
  private static EdgeInspectorDialogOld dialog;
  ...
  {
    if(dialog == null)
      dialog = new EdgeInspectorDialogOld(f,comp,edge);
    else
  ...
  Vector nodeList;
  Model mod; //todo fix
  private EdgeInspectorDialogOld(JFrame frame,
   ...
   // nodeList = mod.getAllNodes();
    ...
    parameters.addDoubleClickedListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent event)
      {
        ...
        boolean modified = EdgeParameterDialog.showDialog(myFrame,EdgeInspectorDialogOld.this,ep);
        if(modified) {
