...
/**
 * <p>A small example illustrating the use of RandomVariate and RandomVariateFactory
 * in generating random variates from a particular distribution, in this case
 * a Beta(2.3, 4.5).</p>
 * <p>Note that in a simulation model, the SimpleStats instance will typically
 * get its values via the PropertyChangeListener pattern (i.e. it will be
