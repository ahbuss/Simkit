...
* Each SimpleServer will have a corresponding {@link PropertyChangeNamespace} that listens for
...
* listens to all of the SimpleServer's PropertyChangeNamespaces and re-fires the events.
