...
public class EventList implements BasicEventList {
    ...
    /**
     * Holds a list of entities with Run events. Note: It is up to the SimEntity
     * to add itself. (This is implemented in BasicSimEntity.)
     */
    ...
    /**
     * The identifying number of this <CODE>EventList</CODE> instance. It is the
     * responsibility of <CODE>Schedule</CODE> to ensure uniqueness across
...
//force setFastInterrupts to initialize correctly.
    ...
    @Override
    public String getStopEventName() {
    ...
    @Override
    public SimEvent getCurrentSimEvent() {
        return currentSimEvent;
    }
     ...
     * <LI>Removes all listeners for every transient <CODE>SimEntity</CODE> in
     * reRun.
     * </UL>
     */
    @Override
     ...
     * <CODE>SimEntity</CODE>
     *
     * @param se The <CODE>SimEntity</CODE> for which listeners are to be
     * removed
     */
    ...
    /**
     * Removes all canceled events from the front of the Event List. This should
     * not be as necessary as it once was. Should only be called from inside a
     * block synchronized on "eventList"
     */
    ...
    /**
     * Sets all stop modes to false. This is used if the user will terminate the
     * run based on other criteria.
     */
    @Override
    ...
    /**
     * Adds one to the number of this event that have occurred. Used for
     * <CODE>stopOnEvent</CODE> This method is not synchronized since it is only
...
//                        }
    ...
    /**
     * @return shallow copy of actual events. To be used by subclasses only for
     * debugging purposes.
     */
     ...
     * in the secondary table could add to run time.
     *
     * @return true, if pending SimEvents will be stored in a secondary hash
     * table to make them easier to find when interrupting.
     */
    public boolean isFastInterrupts() {
        return fastInterrupts;
    }
