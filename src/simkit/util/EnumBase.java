...
/**
 * Serve as a base class for 1.4 style enums. 1.5 style is not used since we
...
public abstract class EnumBase implements Comparable<EnumBase> {
     ...
     * @throws IllegalArgumentException if an enum of the same name and type
     * already exists.
     *
     */
    ...
    /**
     * Finds the enum with the given name and Class. Returns null if there are
     * no enums of the given Class or if one with the given name is not found.
     *
    ...
    /**
     * Returns true if the serials are the same. (Which should also mean that
     * the names and Class are the same.)
     *
    ...
    /**
     * Resets EnumBase back to its original, just loaded condition. Primarily to
     * support testing.
     *
     */
