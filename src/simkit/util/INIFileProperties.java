...
/**
 * Used to hold Properties that can be accessed using a block name and property
 * name. Supports reading and writing the properties to a text file. Access to
 * the properties is via the <CODE>get</CODE> and <CODE>put</CODE> methods
 * inherited from <CODE>Hashtable2</CODE>.
 ...
 * etc.</CODE><P>
 * Note: This class is similar to java.util.Properties, but adds blocks so that
...
public class INIFileProperties extends LinkedHashMap<String, Map<String, String>> {
     ...
     *
     * @param instream Given input stream
    ...
    /**
     * Loads an ini file from the given filename. Note: This version of load
     * does not throw on IOException, it simply prints a warning to stderr.
     *
...
*
    ...
    /**
     * Loads an ini file from the given File. Simply invokes the Load(URL)
     * method.
     *
    ...
    /**
     * Saves the Hashtable2 as an ini file to File outFile. Note that all
     * comments are lost.
     *
    ...
    /**
     * @return a String containing the properties in output file format.
     */
    @Override
