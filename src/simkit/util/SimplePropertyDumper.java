 ...
 * registers with to stdout. The format of the output is: The index of the
 * property (if it is an IndexedProperyChangeEvent), the source of the property
 * (if dumpSource is true; the default is false), the name of the property, the
 * previous value of the property (if not null), the new value of the property.
...
public class SimplePropertyDumper implements PropertyChangeListener {
     ...
     *
     * @param dumpSource If true, the source of the property change is included
     * in the output.
     *
     */
    ...
    /**
     *
     * @param dumpsource true, if the source of the property change will be
    ...
    /**
     *
     * @return true, if the source of the property change will be included in the
     * output.
     */
