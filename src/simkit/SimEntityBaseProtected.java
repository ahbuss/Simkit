 ...
 * methods. Warning: Currently a prototype.
 *
 * @author Arnold Buss
 * @author K. A. Stork
...
*
     ...
     * private.
     *
     * @return True if the entity has a doRun method.
     */
    @Override
     ...
     * priority. The name is the class name plus a unique serial number.
     *
     ...
     * @return all the do Methods for this entity.
     */
    protected Map<String, Method> getDoMethods() {
        Map<String, Method> doMethods = new LinkedHashMap<>();
        ...
        while (clazz != null) {
            if (debug) {
                System.out.println("+++ Checking class: " + clazz.getName() + " for do methods");
            }
            Method[] methods = clazz.getDeclaredMethods(); //Get methods declared in this class.
            for (Method method : methods) {
                String fullName = getFullMethodName(method, true); //name + wrapped signature.
                if (debug) {
                    System.out.print("\tFound: " + fullName + "...");
                }
                ...
                if (fullName.startsWith(EVENT_METHOD_PREFIX) && !doMethods.containsKey(fullName)) {
                    doMethods.put(fullName, method);
                    if (method.getName().equals("doRun")) {
                        reRunnable = true;
                        if (debug) {
                            System.out.print("Found a doRun, setting reRunnable to true ... ");
                        }
                    } //endif doRun.
                    if (debug) {
...
*
     ...
     * @param parameters An array of Class objects that are the signature of the
     * method.
     * @param wrap If true, primatives will be converted into Objects.
     * @return the method name plus signature as a String.
     */
     ...
     * @param wrap If true wrap primitives in an Object. (e.g., "int" is
     * replaced by "java.lang.Integer"
     * @return a String containing the Method name plus the signature, with any
     * primitive parameters optionally wrapped in an Object.
     */
     ...
     * arguments and are therefore equivelent.
*
     */
